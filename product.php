...
<html>
<head>
<title>Product - Silahkan Login Untuk Berbelanja</title>
...
<div id="container">
	...
	<div class="nav1">
		<ul>
			<li><a href="product.php" class="active" style="color:#111;">Ikan Laut</a></li>
	...
	<div id="content">
		...
		<div id="product">
			...
			include ('function/addcart.php');
				...
				$query = mysqli_query($conn, "SELECT *FROM product WHERE category='ikanlaut' ORDER BY product_id DESC") or die (mysqli_error());
